    ...
    <footer id="contact" className="relative overflow-hidden contact-matte-bg">
      <div className="container px-4 md:px-6 lg:px-12 max-w-[1400px] mx-auto relative z-10 pt-24 pb-12">
        ...
        <div className="flex flex-col items-center justify-center pt-8">
          ...
          {/* Logo */}
          <div className="flex items-center space-x-3 md:space-x-4 mb-8 group">
            <img src="/logo.svg" alt="Kenet Technologies Icon" className="h-16 w-auto flex-shrink-0 group-hover:scale-105 transition-transform duration-300" />
            <img src="/logo-text.svg" alt="Kenet Technologies" className="h-9 w-auto flex-shrink-0 mt-1 opacity-90 group-hover:opacity-100 transition-opacity duration-300" />
          </div>
